...
\begin{table}[h]
  ...
  \hline
  Min. cost (PV + WT + Bat + grid) & 47.73 & 129 713.08 & 49.03   \\
  \hline
  Min. cost (PV + Bat + grid)      & 50.87   & 131 597.65 & 51.56 \\
  \hline
  Min. cost (WT + Bat + grid)      & 64.66  &  201 525.93 & 85.89 \\
  \hline
  Min. \ch{CO2} (PV + Bat + grid) & 78.92 & 37 778.79 & 16.90  \\
  \hline
  Min. \ch{CO2} (WT + Bat + grid) & 281.29  &   58 263.38 & 22.43 \\
  \hline
  Min. \ch{CO2} (PV +WT+  Bat + grid) & 118.31 &  24 373.88 & 5.83 \\
  \hline
    Only grid   & 75.39        & 201 211.31      & 100.00                \\
  \hline
  \end{tabular}  
\end{table}
...
\begin{tabular}{|l|r|}
  ...
  \textbf{Scenarios} & \textbf{Emissions ($t\,\ch{CO2}-eq$)}   \\
  \hline  
   Sizing with all the information of the 10  (optimal solution)  &   240 154.86    \\  
  \hline
    Sizing with information of the current year                   &   266 035.35     \\
  \hline
